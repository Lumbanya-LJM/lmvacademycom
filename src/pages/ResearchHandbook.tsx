...
import { FileText, Check, Loader2, ArrowLeft, CreditCard, Smartphone, Download } from "lucide-react";
...
const included = [
  "A practical guide to academic and legal research",
  "Written and reviewed by experienced lawyers",
  "Templates for research proposals and reports",
  "Tips on sourcing, citation and structuring your research",
  "Instant PDF download after payment — yours to keep forever",
];

const ResearchHandbook = () => {
  ...
  const whatsappUrl = `https://wa.me/${WHATSAPP_NUMBER}?text=${encodeURIComponent(
    `Hello LMV Academy, I'm ${fullName.trim() || "a student"}. I have paid for the Research Handbook (K500) via mobile money. Please send me a received confirmation. My email: ${email.trim()}`
  )}`;
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await openCheckout({
        priceId: "research_handbook_full",
        quantity: 1,
        customerEmail: email.trim().toLowerCase(),
        customData: { purchaseId },
        successUrl: `${window.location.origin}/handbook/success?id=${purchaseId}&product=research`,
      });
    } catch (err) {
      console.error(err);
      toast({
  ...
  return (
    <>
      <Helmet>
        <title>Research Handbook | Buy & Download</title>
        <meta
          name="description"
          content="Buy the LMV Academy Research Handbook for K500 / $26. Pay by card or mobile money and download your PDF instantly."
        />
      </Helmet>
            ...
            <div className="grid md:grid-cols-2 gap-10 items-start">
              ...
              <div>
                ...
                <p className="font-body text-muted-foreground leading-relaxed mb-6">
                  Your essential digital research companion. Pay once and download the
                ...
                <div className="flex items-baseline gap-3">
                  <span className="font-heading text-3xl font-bold text-foreground">K500</span>
                  <span className="font-body text-muted-foreground">/ $26 — one-time payment</span>
                </div>
                ...
                {mobileRegistered ? (
                  <div className="space-y-5">
                    <div className="bg-primary/5 border border-primary/20 rounded-lg p-5">
                      ...
                      <ol className="list-decimal list-inside space-y-2 font-body text-sm text-foreground">
                        <li>Send <strong>K500</strong> via Airtel Money to agent code <strong className="text-primary">20319930</strong>.</li>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-5">
                    ...
                    >
                      ...
                      {paymentMethod === "card" ? "Buy the handbook — K500 / $26" : "Pay K500 with Mobile Money"}
                    </button>
...
export default ResearchHandbook;
